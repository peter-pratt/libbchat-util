 ...
 * on localhost:1053 coming from Session Router's embedded libunbound (when exit mode is enabled), wraps
 ...
 *
 * So for a Session Router configuration of "upstream=1.1.1.1", when exit mode is OFF:
