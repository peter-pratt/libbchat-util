...
LIBBCHAT_EXPORT int groups_members_init(
        config_object** conf,
...
///
/// Fills `member` with the member info given a bchat ID (specified as a null-terminated hex
...
LIBBCHAT_EXPORT bool groups_members_get(
        config_object* conf,
...
/// all the member fields to defaults and loads it with the given bchat_id.
///
...
///   invalid bchat_id).
LIBBCHAT_EXPORT bool groups_members_get_or_construct(
        config_object* conf,
        config_group_member* member,
        const char* bchat_id) LIBBCHAT_WARN_UNUSED;
...
LIBBCHAT_EXPORT bool groups_members_set(config_object* conf, const config_group_member* member);
...
/// the group.
LIBBCHAT_EXPORT GROUP_MEMBER_STATUS
...
/// Outputs:
/// - `bool` -- Returns true if the call succeeds, false if an error occurs.
LIBBCHAT_EXPORT bool groups_members_set_invite_sent(config_object* conf, const char* bchat_id);
...
/// Outputs:
/// - `bool` -- Returns true if the call succeeds, false if an error occurs.
LIBBCHAT_EXPORT bool groups_members_set_invite_not_sent(
...
LIBBCHAT_EXPORT bool groups_members_set_invite_failed(
        config_object* conf, const char* bchat_id);
...
/// Outputs:
/// - `bool` -- True if change was successful
LIBBCHAT_EXPORT bool groups_members_set_invite_accepted(
        config_object* conf, const char* bchat_id);
...
/// Outputs:
/// - `bool` -- True if change was successful
LIBBCHAT_EXPORT bool groups_members_set_promoted(config_object* conf, const char* bchat_id);
...
/// Outputs:
/// - `bool` -- True if change was successful
LIBBCHAT_EXPORT bool groups_members_set_promotion_sent(
        config_object* conf, const char* bchat_id);
...
/// Outputs:
/// - `bool` -- True if change was successful
LIBBCHAT_EXPORT bool groups_members_set_promotion_failed(
        config_object* conf, const char* bchat_id);
...
/// Outputs:
/// - `bool` -- True if change was successful
LIBBCHAT_EXPORT bool groups_members_set_promotion_accepted(
        config_object* conf, const char* bchat_id);
...
/// Outputs:
/// - `bool` -- True if change was successful
LIBBCHAT_EXPORT bool groups_members_set_removed(
        config_object* conf, const char* bchat_id, bool messages);

/// API: groups/groups_members_erase
///
/// Erases a member from the member list.  bchat_id is in hex.  Returns true if the member was
...
LIBBCHAT_EXPORT bool groups_members_erase(config_object* conf, const char* bchat_id);
...
LIBBCHAT_EXPORT size_t groups_members_size(const config_object* conf);
...
///         // c.bchat_id, c.name, etc. are loaded
///     }
...
LIBBCHAT_EXPORT groups_members_iterator* groups_members_iterator_new(const config_object* conf);
...
LIBBCHAT_EXPORT void groups_members_iterator_free(groups_members_iterator* it);
...
LIBBCHAT_EXPORT bool groups_members_iterator_done(
...
/// Inputs:
/// - `it` -- [in] Pointer to the groups_members_iterator
LIBBCHAT_EXPORT void groups_members_iterator_advance(groups_members_iterator* it);
