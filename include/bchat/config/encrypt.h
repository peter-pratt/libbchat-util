...
///
/// Wrapper around bchat::config::encrypt.  message and key_base are binary: message has the
...
///
/// Wrapper around bchat::config::decrypt.  ciphertext and key_base are binary: ciphertext has the
/// length provided, key_base must be exactly 32 bytes.  domain is a c string.  Returns a newly
