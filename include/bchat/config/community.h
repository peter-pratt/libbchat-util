...
LIBBCHAT_EXPORT extern const size_t COMMUNITY_BASE_URL_MAX_LENGTH;

// Maximum string length of a community room token
LIBBCHAT_EXPORT extern const size_t COMMUNITY_ROOM_MAX_LENGTH;
...
LIBBCHAT_EXPORT extern const size_t COMMUNITY_FULL_URL_MAX_LENGTH;
...
LIBBCHAT_EXPORT bool community_parse_full_url(
...
LIBBCHAT_EXPORT bool community_parse_partial_url(
        const char* full_url,
        char* base_url,
        char* room_token,
...
LIBBCHAT_EXPORT void community_make_full_url(
