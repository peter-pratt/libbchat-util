...
LIBBCHAT_EXPORT void onion_request_builder_init(onion_request_builder_object** builder);
...
LIBBCHAT_EXPORT void onion_request_builder_free(onion_request_builder_object* builder);

/// API: onion_request_builder_set_enc_type
///
/// Wrapper around bchat::onionreq::Builder::onion_request_builder_set_enc_type.
///
/// Inputs:
/// - `builder` -- [in] Pointer to the builder object
/// - `enc_type` -- [in] The encryption type to use in the onion request
LIBBCHAT_EXPORT void onion_request_builder_set_enc_type(
        onion_request_builder_object* builder, ENCRYPT_TYPE enc_type);

/// API: onion_request_builder_set_mnode_destination
///
/// Wrapper around bchat::onionreq::Builder::set_mnode_destination.  ed25519_pubkey and
/// x25519_pubkey are both hex strings and must both be exactly 64 characters.
///
/// Inputs:
/// - `builder` -- [in] Pointer to the builder object
/// - `ip` -- [in] The IP address for the mnode destination
/// - `quic_port` -- [in] The Quic port request for the mnode destination
/// - `ed25519_pubkey` -- [in] The ed25519 public key for the mnode destination
LIBBCHAT_EXPORT void onion_request_builder_set_mnode_destination(
...
///
/// Wrapper around bchat::onionreq::Builder::set_server_destination.  x25519_pubkey
...
LIBBCHAT_EXPORT void onion_request_builder_set_server_destination(
        onion_request_builder_object* builder,
        const char* protocol,
        const char* host,
        const char* method,
...
///
/// Wrapper around bchat::onionreq::Builder::add_hop.  ed25519_pubkey and
/// x25519_pubkey are both hex strings and must both be exactly 64 characters.
///
/// Declaration:
/// ```cpp
...
/// Inputs:
/// - `builder` -- [in] Pointer to the builder object
/// - `ed25519_pubkey` -- [in] The ed25519 public key for the mnode hop
/// - `x25519_pubkey` -- [in] The x25519 public key for the mnode hop
LIBBCHAT_EXPORT void onion_request_builder_add_hop(
        onion_request_builder_object* builder,
        const char* ed25519_pubkey,
        const char* x25519_pubkey);
...
///
/// Wrapper around bchat::onionreq::Builder::build.  payload_in is binary: payload_in
...
LIBBCHAT_EXPORT bool onion_request_builder_build(
        onion_request_builder_object* builder,
