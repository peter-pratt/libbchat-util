...
struct hash<bchat::network::pubkey_base<Derived, N>> {
    size_t operator()(const bchat::network::pubkey_base<Derived, N>& pk) const {
...
template <>
struct hash<bchat::network::legacy_pubkey> : hash<bchat::network::legacy_pubkey::PubKeyBase> {};
template <>
struct hash<bchat::network::x25519_pubkey> : hash<bchat::network::x25519_pubkey::PubKeyBase> {};
template <>
struct hash<bchat::network::ed25519_pubkey> : hash<bchat::network::ed25519_pubkey::PubKeyBase> {
};
